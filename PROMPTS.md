...
The other side should display the conference schedule (the order of the speakers' sessions, with a lunch break after the first two sessions).

Check my whole HTML and CSS code to understand the existing sizes, colors, spacing, and overall design style. Make this section more professional so that it matches my website.